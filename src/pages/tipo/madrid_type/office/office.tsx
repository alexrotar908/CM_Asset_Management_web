// src/pages/tipo/madrid_type/office/office.tsx
...
export default function Office() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // 🔎 Propiedades tipo office en Madrid
        ...
        if (!mounted) return;
        setError(e?.message || 'Error al cargar Offices (Madrid)');
      } finally {
        if (!mounted) return;
        setLoading(false);
      }
  ...
  if (loading) {
    return <div className="office-page"><h2>Cargando Oficinas (Madrid)…</h2></div>;
  }
  if (error) {
    return <div className="office-page"><h2>Error: {error}</h2></div>;
  }
    ...
    <div className="office-page">
      <div className="office-content">
        ...
        <div className="breadcrumb">
          ...
          <span className="breadcrumb-current">Oficinas</span>
        </div>

        <div className="office-header">
          <h1>Oficinas</h1>
          <div className="office-subheader">
        ...
        <div className="office-grid">
          {paginated.map((prop) => (
            <div key={prop.id} className="office-card">
