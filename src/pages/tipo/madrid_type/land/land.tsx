// src/pages/tipo/madrid_type/land/land.tsx
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Todas las propiedades de tipo "land" en Madrid
        ...
        const mapped: Property[] = (data ?? []).map((p: any) => {
          ...
          // Ordenar imágenes por id para consistencia
        ...
        // Orden estable en cliente (evitamos order() sobre relación)
        ...
        if (!mounted) return;
        setError(e?.message || 'Error al cargar Land (Madrid)');
      } finally {
        if (!mounted) return;
        setLoading(false);
      }
  ...
  if (loading) {
    return (
      <div className="land-page">
        <div className="land-content"><h2>Cargando Land (Madrid)…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="land-page">
        <div className="land-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
    ...
    <div className="land-page">
      <div className="land-content">
        ...
        <div className="breadcrumb">
          ...
          <span className="breadcrumb-current">Land</span>
        </div>

        <div className="land-header">
          <h1>Land</h1>
          <div className="land-subheader">
