// src/pages/tipo/madrid_type/loft/loft.tsx
...
export default function Loft() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Traemos todas las propiedades de tipo loft en Madrid
        ...
        if (!mounted) return;
        setError(e?.message || 'Error al cargar Lofts (Madrid)');
      } finally {
        if (!mounted) return;
        setLoading(false);
      }
  ...
  if (loading) {
    return (
      <div className="loft-page">
        <div className="loft-content"><h2>Cargando Lofts (Madrid)…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="loft-page">
        <div className="loft-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
    ...
    <div className="loft-page">
      <div className="loft-content">
        ...
        <div className="breadcrumb">
          ...
          <span className="breadcrumb-current">Loft</span>
        </div>

        <div className="loft-header">
          <h1>Lofts</h1>
          <div className="loft-subheader">
        ...
        <div className="loft-grid">
          {paginated.map((prop) => (
            <div key={prop.id} className="loft-card">
              <div
