  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Todas las propiedades cuyo tipo tenga slug 'atico' en la ciudad de Madrid.
  ...
  if (loading) {
    return (
      <div className="atico-page">
        <div className="atico-content"><h2>Cargando áticos en Madrid…</h2></div>
      </div>
    );
  }
  if (error) {
