...
export default function CasaBucharest() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!mounted) return;
        setError(e?.message || 'Error al cargar casa');
      } finally {
        if (!mounted) return;
        setLoading(false);
      }
  ...
  if (loading) {
    return (
      <div className="casa-page">
        <div className="casa-content"><h2>Cargando casas en Bucharest…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="casa-page">
        <div className="casa-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
    ...
    <div className="casa-page">
      <div className="casa-content">
        ...
        <div className="breadcrumb">
          ...
          <span className="breadcrumb-current">Casas</span>
        </div>

        <div className="casa-header">
          <h1>Casas</h1>
          <div className="casa-subheader">
