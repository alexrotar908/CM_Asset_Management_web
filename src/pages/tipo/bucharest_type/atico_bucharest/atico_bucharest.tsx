...
export default function AticoBucharest() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Todas las propiedades cuyo tipo tenga slug 'atico' en la ciudad de Bucharest.
  ...
  if (loading) {
    return (
      <div className="atico-page">
        <div className="atico-content"><h2>Cargando áticos en Bucharest…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="atico-page">
        <div className="atico-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="atico-page">
      <div className="atico-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current">Ático</span>
        </div>

        <div className="atico-header">
          <h1>Ático</h1>
          <div className="atico-subheader">
        ...
        <div className="atico-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="atico-card clickable"
