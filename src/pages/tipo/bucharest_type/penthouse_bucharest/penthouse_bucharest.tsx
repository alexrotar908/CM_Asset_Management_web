...
import './penthouse_bucharest.css';
...
export default function PenthouseBucharest() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Todas las propiedades cuyo tipo tenga slug 'penthouse' en la ciudad de Bucharest.
  ...
  if (loading) {
    return (
      <div className="penthouse-page">
        <div className="penthouse-content"><h2>Cargando penthouse en Bucharest…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="penthouse-page">
        <div className="penthouse-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
    ...
    <div className="penthouse-page">
      <div className="penthouse-content">
        ...
        <div className="breadcrumb">
          ...
          <span className="breadcrumb-current">Pethouse</span>
        </div>

        <div className="penthouse-header">
          <h1>Penthouse</h1>
          <div className="penthouse-subheader">
        ...
        <div className="penthouse-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="penthouse-card clickable"
      ...
      <footer className="penthouse-footer">
