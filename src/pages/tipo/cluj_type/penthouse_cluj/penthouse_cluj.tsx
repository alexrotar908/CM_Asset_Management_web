...
export default function PenthouseCluj() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Todas las propiedades cuyo tipo tenga slug 'penthouse' en la ciudad de Cluj.
  ...
  if (loading) {
    return (
      <div className="penthouse-page">
        <div className="penthouse-content"><h2>Cargando penthouse en Cluj Napoca…</h2></div>
      </div>
    );
  }
  if (error) {
