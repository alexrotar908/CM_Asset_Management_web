...
export default function AticoCluj() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Todas las propiedades cuyo tipo tenga slug 'atico' en la ciudad de Cluj.
  ...
  if (loading) {
    return (
      <div className="atico-page">
        <div className="atico-content"><h2>Cargando áticos en Cluj Napoca…</h2></div>
      </div>
    );
  }
  if (error) {
