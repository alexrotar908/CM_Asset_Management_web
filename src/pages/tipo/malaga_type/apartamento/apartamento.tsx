// src/pages/tipo/malaga_type/apartments/apartments.tsx
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!mounted) return;
        setError(e?.message || 'Error al cargar Apartamentos (Málaga)');
      } finally {
        if (!mounted) return;
        setLoading(false);
      }
  ...
  if (loading) {
    return (
      <div className="apartments-page">
        <div className="apartments-content"><h2>Cargando Apartamentos en Málaga…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="apartments-page">
        <div className="apartments-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
    ...
    <div className="apartments-page">
      <div className="apartments-content">
        ...
        <div className="apartments-header">
          <h1>Apartamentos</h1>
          <div className="apartments-subheader">
        ...
        <div className="apartments-grid">
          {paginated.map((prop) => (
            <div key={prop.id} className="apartments-card">
              <div
      ...
      <footer className="apartments-footer">
