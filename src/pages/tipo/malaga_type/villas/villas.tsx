// src/pages/tipo/malaga_type/villas/villas.tsx
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!mounted) return;
        setError(e?.message || 'Error al cargar Villas (Málaga)');
      } finally {
        if (!mounted) return;
        setLoading(false);
      }
  ...
  if (loading) {
    return (
      <div className="villas-page">
        <div className="villas-content"><h2>Cargando Villas en Málaga…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="villas-page">
        <div className="villas-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
    ...
    <div className="villas-page">
      <div className="villas-content">
        <div className="breadcrumb">
          ...
          <span className="breadcrumb-current">Villas</span>
        </div>

        <div className="villas-header">
          <h1>Villas en Málaga</h1>
          <div className="villas-subheader">
        ...
        <div className="villas-grid">
          {paginated.map((prop) => (
            <div key={prop.id} className="villas-card">
              <div
      ...
      <footer className="villas-footer">
