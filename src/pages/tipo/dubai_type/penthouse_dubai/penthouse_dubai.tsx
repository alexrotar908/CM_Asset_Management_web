...
export default function PenthouseDubai() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Todas las propiedades cuyo tipo tenga slug 'penthouse' en la ciudad de Dubai City.
  ...
  if (loading) {
    return (
      <div className="penthouse-page">
        <div className="penthouse-content"><h2>Cargando penthouse en Dubai City…</h2></div>
      </div>
    );
  }
  if (error) {
