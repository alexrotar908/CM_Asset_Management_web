...
export default function AticoDubai() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Todas las propiedades cuyo tipo tenga slug 'atico' en la ciudad de Dubai City.
  ...
  if (loading) {
    return (
      <div className="atico-page">
        <div className="atico-content"><h2>Cargando áticos en Dubai City…</h2></div>
      </div>
    );
  }
  if (error) {
