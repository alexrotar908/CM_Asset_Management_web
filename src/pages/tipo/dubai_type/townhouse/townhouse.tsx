...
export default function TownhouseDubai() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Todas las propiedades cuyo tipo tenga slug 'townhouse' en la ciudad de Dubai City.
  ...
  if (loading) {
    return (
      <div className="townhouse-page">
        <div className="townhouse-content"><h2>Cargando townhouse en Dubai City…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="townhouse-page">
        <div className="townhouse-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="townhouse-page">
      <div className="townhouse-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current">Townhouse</span>
        </div>

        <div className="townhouse-header">
          <h1>Townhouse</h1>
          <div className="townhouse-subheader">
        ...
        <div className="townhouse-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="townhouse-card clickable"
      ...
      <footer className="townhouse-footer">
