...
export default function ApartamentoLujoDubai() {
    ...
    (async () => {
      try {
        ...
        const { data, error } = await supabase
          ...
          `)
          .eq('tipos.slug', 'apartamento-de-lujo')
  ...
  if (loading) {
    return (
      <div className="apartamento-page">
        <div className="apartamento-content"><h2>Cargando apartamentos en Dubai…</h2></div>
      </div>
    );
  }
  if (error) {
    ...
    <div className="apartamento-page">
      <div className="apartamento-content">
        ...
        <div className="breadcrumb">
          ...
          <span className="breadcrumb-current">Luxury Apartments</span>
        </div>
