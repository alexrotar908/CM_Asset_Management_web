...
export default function Manastur() {
  ...
  if (loading) {
    return (
      <div className="manastur-page">
        <div className="manastur-content"><h2>Cargando propiedades de Manastur</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="manastur-page">
        <div className="manastur-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="manastur-page">
      <div className="manastur-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current">Manastur</span>
        </div>

        <div className="manastur-header">
          <h1>Manastur</h1>
          <div className="manastur-subheader">
        ...
        <div className="manastur-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="manastur-card clickable"
              role="button"
              tabIndex={0}
      ...
      <footer className="manastur-footer">
