...
export default function ClujCentral() {
  ...
  if (loading) {
    return (
      <div className="clujcentral-page">
        <div className="clujcentral-content"><h2>Cargando propiedades de Cluj Central</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="clujcentral-page">
        <div className="clujcentral-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="clujcentral-page">
      <div className="clujcentral-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current">Cluj Central</span>
        </div>

        <div className="clujcentral-header">
          <h1>Cluj Central</h1>
          <div className="clujcentral-subheader">
        ...
        <div className="clujcentral-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="clujcentral-card clickable"
              role="button"
              tabIndex={0}
      ...
      <footer className="clujcentral-footer">
