...
export default function Zorilor() {
  ...
  if (loading) {
    return (
      <div className="zorilor-page">
        <div className="zorilor-content"><h2>Cargando propiedades de Zorilor</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="zorilor-page">
        <div className="zorilor-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="zorilor-page">
      <div className="zorilor-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current">Zorilor</span>
        </div>

        <div className="zorilor-header">
          <h1>Zorilor</h1>
          <div className="zorilor-subheader">
        ...
        <div className="zorilor-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="zorilor-card clickable"
              role="button"
              tabIndex={0}
      ...
      <footer className="zorilor-footer">
