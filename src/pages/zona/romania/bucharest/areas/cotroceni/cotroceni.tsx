...
export default function Cotroceni() {
  ...
  if (loading) {
    return (
      <div className="cotroceni-page">
        <div className="cotroceni-content"><h2>Cargando propiedades de Cotroceni</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="cotroceni-page">
        <div className="cotroceni-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="cotroceni-page">
      <div className="cotroceni-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current">Cotroceni</span>
        </div>

        <div className="cotroceni-header">
          <h1>Cotroceni</h1>
          <div className="cotroceni-subheader">
        ...
        <div className="cotroceni-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="cotroceni-card clickable"
              role="button"
              tabIndex={0}
      ...
      <footer className="cotroceni-footer">
