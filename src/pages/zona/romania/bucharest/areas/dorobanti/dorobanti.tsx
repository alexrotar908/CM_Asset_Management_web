...
export default function Dorobanti() {
  ...
  if (loading) {
    return (
      <div className="dorobanti-page">
        <div className="dorobanti-content"><h2>Cargando propiedades de Dorobanti…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="dorobanti-page">
        <div className="dorobanti-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="dorobanti-page">
      <div className="dorobanti-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current">Dorobanti</span>
        </div>

        <div className="dorobanti-header">
          <h1>Dorobanti</h1>
          <div className="dorobanti-subheader">
        ...
        <div className="dorobanti-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="dorobanti-card clickable"
              role="button"
              tabIndex={0}
      ...
      <footer className="dorobanti-footer">
