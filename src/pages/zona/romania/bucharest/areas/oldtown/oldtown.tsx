...
export default function Oldtown() {
  ...
  if (loading) {
    return (
      <div className="oldtown-page">
        <div className="oldtown-content"><h2>Cargando propiedades de Old Town…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="oldtown-page">
        <div className="oldtown-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="oldtown-page">
      <div className="oldtown-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current">Old Town</span>
        </div>

        <div className="oldtown-header">
          <h1>Old Town</h1>
          <div className="oldtown-subheader">
        ...
        <div className="oldtown-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="oldtown-card clickable"
              role="button"
              tabIndex={0}
      ...
      <footer className="oldtown-footer">
