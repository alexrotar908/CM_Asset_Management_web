...
export default function Pipera() {
  ...
  if (loading) {
    return (
      <div className="pipera-page">
        <div className="pipera-content"><h2>Cargando propiedades de Pipera…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="pipera-page">
        <div className="pipera-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="pipera-page">
      <div className="pipera-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current">Pipera</span>
        </div>

        <div className="pipera-header">
          <h1>Pipera</h1>
          <div className="pipera-subheader">
        ...
        <div className="pipera-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="pipera-card clickable"
              role="button"
              tabIndex={0}
      ...
      <footer className="pipera-footer">
