...
export default function DowntownDubai() {
      ...
      try {
        ...
        const mapped: Property[] = (data ?? []).map((p: any) => {
          ...
          return {
            ...
            province: zona?.ciudad ?? 'Downtown Dubai',
  ...
  if (loading) {
    return (
      <div className="downtown-page">
        <div className="downtown-content"><h2>Cargando propiedades de Downtown Dubai…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="downtown-page">
        <div className="downtown-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="downtown-page">
      <div className="downtown-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current">Downtown Dubai</span>
        </div>

        <div className="downtown-header">
          <h1>Downtown Dubai</h1>
          <div className="downtown-subheader">
        ...
        <div className="downtown-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="downtown-card clickable"
              role="button"
              tabIndex={0}
      ...
      <footer className="downtown-footer">
