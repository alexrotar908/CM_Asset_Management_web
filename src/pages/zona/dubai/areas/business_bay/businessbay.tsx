...
export default function BusinessBay() {
      ...
      try {
        ...
        const mapped: Property[] = (data ?? []).map((p: any) => {
          ...
          return {
            ...
            province: zona?.ciudad ?? 'Business Bay',
  ...
  if (loading) {
    return (
      <div className="businessbay-page">
        <div className="businessbay-content"><h2>Cargando propiedades de Business Bay…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="businessbay-page">
        <div className="businessbay-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="businessbay-page">
      <div className="businessbay-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current">Business Bay</span>
        </div>

        <div className="businessbay-header">
          <h1>Business Bay</h1>
          <div className="businessbay-subheader">
        ...
        <div className="businessbay-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="businessbay-card clickable"
              role="button"
              tabIndex={0}
      ...
      <footer className="businessbay-footer">
