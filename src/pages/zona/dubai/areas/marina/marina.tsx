...
export default function DubaiMarina() {
      ...
      try {
        ...
        const mapped: Property[] = (data ?? []).map((p: any) => {
          ...
          return {
            ...
            province: zona?.ciudad ?? 'Dubai Marina',
  ...
  if (loading) {
    return (
      <div className="marina-page">
        <div className="marina-content"><h2>Cargando propiedades de Dubai Marina…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="marina-page">
        <div className="marina-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="marina-page">
      <div className="marina-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current"> Dubai Marina </span>
        </div>

        <div className="marina-header">
          <h1>Dubai Marina</h1>
          <div className="marina-subheader">
        ...
        <div className="marina-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="marina-card clickable"
              role="button"
              tabIndex={0}
      ...
      <footer className="marina-footer">
