...
export default function PalmJumeirah() {
      ...
      try {
        ...
        const mapped: Property[] = (data ?? []).map((p: any) => {
          ...
          return {
            ...
            province: zona?.ciudad ?? 'Palm Jumeirah',
            area: zona?.area ?? 'Dubai City',
  ...
  if (loading) {
    return (
      <div className="jumeirah-page">
        <div className="jumeirah-content"><h2>Cargando propiedades de Palm Jumeirah…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="jumeirah-page">
        <div className="jumeirah-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="jumeirah-page">
      <div className="jumeirah-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current"> Palm Jumeirah </span>
        </div>

        <div className="jumeirah-header">
          <h1>Palm Jumeirah</h1>
          <div className="jumeirah-subheader">
        ...
        <div className="jumeirah-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="jumeirah-card clickable"
              role="button"
              tabIndex={0}
      ...
      <footer className="jumeirah-footer">
