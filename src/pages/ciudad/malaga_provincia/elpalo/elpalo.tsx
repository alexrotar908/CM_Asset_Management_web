...
export default function ElPalo() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Trae TODAS las propiedades de El Palo (sin filtrar por categoria/slug)
        ...
        const mapped: Property[] = (data ?? []).map((p: any) => {
          ...
          // Ordena imágenes por id en cliente para tener estabilidad
  ...
  if (loading) {
    return (
      <div className="elpalo-page">
        <div className="elpalo-content"><h2>Cargando propiedades de El Palo…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="elpalo-page">
        <div className="elpalo-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="elpalo-page">
      <div className="elpalo-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current">El Palo</span>
        </div>

        <div className="elpalo-header">
          <h1>El Palo</h1>
          <div className="elpalo-subheader">
        ...
        <div className="elpalo-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="elpalo-card clickable"
      ...
      <footer className="elpalo-footer">
