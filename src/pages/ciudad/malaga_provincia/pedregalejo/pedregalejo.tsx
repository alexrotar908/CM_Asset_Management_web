...
export default function Pedregalejo() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Obtener TODAS las propiedades de Pedregalejo sin filtrar por categoría
  ...
  if (loading) {
    return (
      <div className="pedregalejo-page">
        <div className="pedregalejo-content"><h2>Cargando propiedades de Pedregalejo…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="pedregalejo-page">
        <div className="pedregalejo-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="pedregalejo-page">
      <div className="pedregalejo-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current">Pedregalejo</span>
        </div>

        <div className="pedregalejo-header">
          <h1>Pedregalejo</h1>
          <div className="pedregalejo-subheader">
        ...
        <div className="pedregalejo-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="pedregalejo-card clickable"
      ...
      {/* Footer */}
      <footer className="pedregalejo-footer">
