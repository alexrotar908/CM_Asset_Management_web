// src/zonas/malagueta.tsx
import { useEffect, useMemo, useRef, useState } from 'react';
import './malagueta.css';
...
export default function Malagueta() {
    ...
    (async () => {
      try {
        ...
        const { data, error } = await supabase
          ...
          .in('zonas.area', ['La Malagueta', 'Malagueta'])
  ...
  if (loading) {
    return (
      <div className="malagueta-page">
        <div className="malagueta-content"><h2>Cargando propiedades de La Malagueta…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="malagueta-page">
        <div className="malagueta-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="malagueta-page">
      <div className="malagueta-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current">La Malagueta</span>
        </div>

        <div className="malagueta-header">
          <h1>La Malagueta</h1>
          <div className="malagueta-subheader">
        ...
        <div className="malagueta-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="malagueta-card clickable"
      ...
      <footer className="malagueta-footer">
