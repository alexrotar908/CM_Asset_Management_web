// src/zonas/salamanca.tsx
import { useEffect, useMemo, useRef, useState } from 'react';
import './salamanca.css';
...
export default function Salamanca() {
  ...
  if (loading) {
    return (
      <div className="salamanca-page">
        <div className="salamanca-content"><h2>Cargando propiedades de Salamanca…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="salamanca-page">
        <div className="salamanca-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="salamanca-page">
      <div className="salamanca-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current">Salamanca</span>
        </div>

        <div className="salamanca-header">
          <h1>Salamanca</h1>
          <div className="salamanca-subheader">
        ...
        <div className="salamanca-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="salamanca-card clickable"
      ...
      <footer className="salamanca-footer">
