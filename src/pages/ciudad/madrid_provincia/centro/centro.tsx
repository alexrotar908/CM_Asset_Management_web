  ...
  if (loading) {
    return (
      <div className="centro-page">
        <div className="centro-content"><h2>Cargando propiedades de Centro…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="centro-page">
        <div className="centro-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
    ...
    <div className="centro-page">
      <div className="centro-content">
        ...
        <div className="breadcrumb">
          ...
          <span className="breadcrumb-current">Centro</span>
        </div>

        <div className="centro-header">
          <h1>Centro</h1>
          <div className="centro-subheader">
        ...
        <div className="centro-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="centro-card clickable"
              role="button"
              tabIndex={0}
