// src/zonas/periferia.tsx
import { useEffect, useMemo, useRef, useState } from 'react';
import './periferia.css';
...
export default function Periferia() {
  ...
  if (loading) {
    return (
      <div className="periferia-page">
        <div className="periferia-content"><h2>Cargando propiedades de Periferia…</h2></div>
      </div>
    );
  }
  if (error) {
    return (
      <div className="periferia-page">
        <div className="periferia-content"><h2>Error: {error}</h2></div>
      </div>
    );
  }
  ...
  return (
    <div className="periferia-page">
      <div className="periferia-content">
        {/* Breadcrumb */}
        <div className="breadcrumb">
          <Link to="/" className="breadcrumb-link">Home</Link>
          <span className="breadcrumb-separator">{'>'}</span>
          <span className="breadcrumb-current">Periferia</span>
        </div>

        <div className="periferia-header">
          <h1>Periferia</h1>
          <div className="periferia-subheader">
        ...
        <div className="periferia-grid">
          {paginated.map((prop) => (
            <div
              key={prop.id}
              className="periferia-card clickable"
      ...
      <footer className="periferia-footer">
